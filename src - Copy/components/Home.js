    ...
    <div className="row align-items-center">
      ...
      <div className="col-lg-5 col-md-12 me-auto mt-5 mt-lg-0 ps-lg-11">
        ...
        <ul className="list-unstyled list-icon-3">
          ...
          <li><i className="fas fa-check"></i>99 % Success Rate</li>
          <Link className="btn btn-theme mt-5" to="aboutus">Learn More</Link>
    ...
    <div className="row">
      <div className="col-lg-4 col-md-6">
        <div className="featured-item text-center">
          ...
          <Link className="btn btn-theme" to="services"><span>Learn More</span></Link>
          </div>
        </div>
      </div>
