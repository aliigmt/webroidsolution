          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-7">
              ...
              <div className="contact-main">
                <form id="contact-form" className="row" method="post" action="http://themeht.com/loptus/html/php/contact.php">
            ...
            <div className="col-lg-5 col-md-5 ml-auto sm-mt-5">
              <ul className="contact-info list-unstyled">
                ...
                <li className="mb-4"><i className="flaticon-email"></i><span>Email</span><a href="mailto:info@webroidsolutions.com"> info@webroidsolutions.com</a>
                </li>
                <li className="mb-4"><i className="flaticon-call"></i><span>Phone:</span><a href="tel:+919081816812">+91-9081816812</a>
                </li>
              </ul>
            </div>
          </div>
                ...
                <div className="mapouter">
                  <div className="gmap_canvas">
                    <div className="mapouter"><div className="gmap_canvas">
                      <iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?ll=21.2331719,72.864181&q=Royal Square&t=&z=19&ie=UTF8&iwloc=&output=embed" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0"></iframe>
                      <a rel="nofollow" href="https://couponpeeps.com/cyberghost-coupon-codes/">coupon for cyberghost</a></div>
