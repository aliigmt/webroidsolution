              ...
              <nav className="navbar navbar-expand-lg">
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                  <ul className="navbar-nav mx-auto position-relative">
                     ...
                     <li className="nav-item dropdown">
                        <Link className={splitLocation[1] === "services" ? "nav-link active" : "nav-link"} to="/services"> Services </Link>
                     </li>

           
                     <li className="nav-item dropdown">
                        <Link className={splitLocation[1] === "career" ? "nav-link active" : "nav-link"} to="/career"> Career </Link>
                     </li>

                     <li className="nav-item dropdown">
                        <Link className={splitLocation[1] === "contactus" ? "nav-link active" : "nav-link"} to="/contactus"> Contact Us </Link>
                     </li>
                 </ul>
                </div>
